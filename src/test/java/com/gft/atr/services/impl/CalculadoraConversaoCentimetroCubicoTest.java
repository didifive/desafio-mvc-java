...
@DisplayName("Testes de CalculadoraConversaoCentimetroCubico")
class CalculadoraConversaoCentimetroCubicoTest {
	
	private UnidadeMedida unidade;

  double calculaFatorConversao(UnidadeMedida unidade) throws ImpossivelCalcularFatorConversaoException {
  	return CENTIMETRO_CUBICO.getFator().calculaFatorConversao(unidade);
  }
	...
	@Test
	@DisplayName("1.1. Quando Converter Unidade de Medida com Referência de Mililitro para Centímetro Cúbico Deve Retornar 1")
	void quandoConverterUnidadeDeMedidaComReferenciaDeMililitroParaCentimetroCubicoDeveRetornar1() throws Exception {
		//given
	...
	@Test
	@DisplayName("1.2. Quando Converter Unidade de Medida com Referência de Litro para Centímetro Cúbico 1000")
	void quandoConverterUnidadeDeMedidaComReferenciaDeLitroParaCentimetroCubicoDeveRetornar1000() throws Exception {
		//given
	...
	@Test
	@DisplayName("1.3. Quando Converter Unidade de Medida com Referência Igual Deve Retornar 1")
	...
	@Test
	@DisplayName("1.4. Quando Converter Unidade de Medida com Referência de Metro Cúbico para Centímetro Cúbico Deve Retornar 1000000")
	void quandoConverterUnidadeDeMedidaComReferenciaDeMetroCubicoParaLitroDeveRetornar1000000() throws Exception {
		//given
