...
class CalculadoraConversaoLitroTest {
  ...
  double calculaFatorConversao(UnidadeMedida unidade) throws ImpossivelCalcularFatorConversaoException {
	...
	@Test
	@DisplayName("1.1. Quando Converter Unidade de Medida com Referência de Mililitro para Litro Deve Retornar 0001")
	...
	@Test
	@DisplayName("1.3. Quando Converter Unidade de Medida com Referência de Centimetro Cúbico para Litro Deve Retornar 0001")
	...
	@Test
	@DisplayName("1.4. Quando Converter Unidade de Medida com Referência de Metro Cúbico para Litro Deve Retornar 1000")
